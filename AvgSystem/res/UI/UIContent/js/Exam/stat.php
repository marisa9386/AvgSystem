...
var cnzz_data='&r='+escape(cnzz_ref.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.99897300 1336443324';
var cnzz_a=gc_cnzz("cnzz_a3583776");
...
var cnzz_sin = gc_cnzz("sin3583776");
if(cnzz_sin==-1) cnzz_sin='none';
if( cnzz_ref.split('/')[2]!=document.domain ) cnzz_sin=cnzz_ref;
var cnzz_eid=gc_cnzz("cnzz_eid");
if(cnzz_eid==-1) cnzz_eid=Math.floor(Math.random()*100000000)+"-"+1336443324+"-"+cnzz_ref.substr(0,64);
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=3583776" target=_blank title="&#31449;&#38271;&#32479;&#35745;"><img border=0 hspace=0 vspace=0 src="http://icon.cnzz.com/pic.gif" /></a>');
document.write('<img src="http://hzs22.cnzz.com/stat.htm?id=3583776'+cnzz_data+'" border=0 width=0 height=0 />');
...
document.cookie="cnzz_a3583776="+cnzz_a+";expires="+cnzz_ed.toGMTString()+ "; path=/";
document.cookie="sin3583776="+escape(cnzz_sin)+ ";expires="+cnzz_ed.toGMTString()+";path=/";
